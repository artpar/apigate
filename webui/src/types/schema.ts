...
export interface FieldSchema {
  ...
  default?: unknown;
  internal?: boolean;     // hide from UI/API (e.g., password_hash)
  implicit?: boolean;     // auto-generated by system (id, created_at, updated_at)
  computed?: boolean;     // derived field, not stored
